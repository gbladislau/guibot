...
echo "----- create a venv to use that as the python env (needed for python 3.12 compatibility) -----"
rm -rf docker_venv
...
echo "------------ use coverage also with venv installed packages ------------"
...
echo "------------- contour, template, feature, cascade -------------"
...
apt-get -y install python3-incremental
